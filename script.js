...
btnHold.addEventListener('click', function () {
  if (playing) {
    ...
    // 2. Check if player's score is >= 100. when we finished the game, we want to assign a player winner class (in css:player-winner which has the background color)
